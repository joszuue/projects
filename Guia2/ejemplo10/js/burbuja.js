function inicializar(){
    ...
    opcion = prompt('Seleccione 1: para ascendente o presione 2 para descendente');
        ...
        if(opcion == 1){
            ...
            if(opcion == 2){
                for(i=0; i<max-1; i++){
                    ...
                    var letra = " descendente";
                }
            }
        }

        contenido += "<h1>Números ordenados "+ letra +"</h1>\n";
        contenido += "<table>\n\t<tbody>\n\t\t<tr>\n";
